<?php $__env->startSection('title', __('messages.top_students')); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted mb-0 small"><?php echo e(__('messages.top_students_list')); ?></p>
        </div>
        <a href="<?php echo e(route('admin.top-students.create')); ?>" class="btn btn-primary btn-sm px-4">
            <i class="fas fa-plus mr-1"></i> <?php echo e(__('messages.add_top_student')); ?>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                <div class="card-body py-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="ts-stat-num"><?php echo e($students->count()); ?></div>
                        <div class="ts-stat-label"><?php echo e(__('messages.students_count')); ?></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-4 col-md-3">
            <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                <div class="card-body py-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="ts-stat-num"><?php echo e($students->where('is_active', true)->count()); ?></div>
                        <div class="ts-stat-label"><?php echo e(__('messages.active_count')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm rounded-lg">
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0 ts-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('messages.student_name')); ?></th>
                                    <th><?php echo e(__('messages.school_name_label')); ?></th>
                                    <th><?php echo e(__('messages.rank_label')); ?></th>
                                    <th><?php echo e(__('messages.average_label')); ?></th>
                                    <th><?php echo e(__('messages.photos_section')); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr class="ts-row">
                                    <td class="pl-4 text-muted small"><?php echo e($student->id); ?></td>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="ts-avatar">
                                                <?php if($student->photo): ?>
                                                    <img src="<?php echo e(asset('assets/admin/uploads/' . $student->photo)); ?>"
                                                         alt="<?php echo e($student->name); ?>"
                                                         class="ts-avatar-img"
                                                         data-toggle="tooltip"
                                                         title="<?php echo e(__('messages.student_photo')); ?>">
                                                <?php else: ?>
                                            ...
                                            <div>
                                                <div class="font-weight-600"><?php echo e($student->name); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($student->rank): ?>
                                            ...
                                            ?>
                                            <span class="ts-rank-badge"><?php echo e($rankIcon); ?> <?php echo e($student->rank); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <?php if($student->average): ?>
                                            <strong class="text-success"><?php echo e(number_format($student->average, 2)); ?>%</strong>
                                        <?php else: ?>
                                            <span class="text-muted">—</span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="ts-photos-status">
                                            <span class="ts-photo-dot <?php echo e($student->photo ? 'filled' : ''); ?>"
                                                  data-toggle="tooltip" title="<?php echo e(__('messages.student_photo')); ?>">
                                                <i class="fas fa-user-circle"></i>
                                            </span>
                                            <span class="ts-photo-dot <?php echo e($student->grades_photo ? 'filled' : ''); ?>"
                                                  data-toggle="tooltip" title="<?php echo e(__('messages.grades_photo')); ?>">
                                                <i class="fas fa-file-alt"></i>
                                            </span>
                                            <span class="ts-photo-dot <?php echo e($student->certificate_photo ? 'filled' : ''); ?>"
                                                  data-toggle="tooltip" title="<?php echo e(__('messages.certificate_photo')); ?>">
                                    ...
                                    <td>
                                        <span class="badge badge-light border"><?php echo e($student->order); ?></span>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($student->is_active): ?>
                                            <span class="badge ts-badge-active">
                                                ...
                                                <?php echo e(__('messages.visible')); ?>
                                    ...
                                    <td class="text-muted small">
                                        <?php echo e($student->created_at->format('Y-m-d')); ?>
                                    ...
                                    <td class="text-center">
                                        <div class="ts-actions">
                                            <a href="<?php echo e(route('admin.top-students.edit', $student->id)); ?>"
                                               class="btn btn-sm ts-btn-edit"
                                               data-toggle="tooltip" title="<?php echo e(__('messages.edit')); ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form method="POST"
                                                  action="<?php echo e(route('admin.top-students.destroy', $student->id)); ?>"
                                                  style="display:inline"
                                                  onsubmit="return confirm('<?php echo e(__('messages.confirm_delete_student')); ?>')">
                                                <?php echo csrf_field(); ?>
                    ...
                    <div class="ts-empty-state">
                        ...
                        <h5><?php echo e(__('messages.no_top_students')); ?></h5>
                        <p class="text-muted"><?php echo e(__('messages.no_top_students_desc')); ?></p>
                        <a href="<?php echo e(route('admin.top-students.create')); ?>" class="btn btn-primary btn-sm px-4">
                            <i class="fas fa-plus mr-1"></i> <?php echo e(__('messages.add_top_student')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\khalil\resources\views/admin/top-students/index.blade.php ENDPATH**/ ?>