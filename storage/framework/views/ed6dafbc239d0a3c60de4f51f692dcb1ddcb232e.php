...
<?php endif; ?>
    ...
    <div class="qr-score-card qr-score--<?php echo e(strtolower($attempt->group)); ?>">
        ...
        <div class="qr-score-info">
           <div class="qr-group-badge"><?php echo e(__('messages.group_label')); ?> <?php echo e($attempt->group); ?></div>
            ...
            <div class="qr-score-correct">
                <?php echo e($attempt->score); ?> من <?php echo e($totalMarks); ?> علامة
            </div>
            <div class="qr-score-questions">
                <?php echo e($attempt->total_questions); ?> سؤال
            </div>
        </div>
    </div>
...
<?php endif; ?>
    ...
    <div class="qr-review">
        ...
        <div class="qr-answers-grid">
            <?php $__currentLoopData = $answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qId => $ans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                ...
                $userAns  = $ans['user']    ?? '';
            ?>
            <div class="qr-answer <?php echo e($isRight ? 'correct' : 'wrong'); ?>">
                <div class="qr-answer-top">
                    <span class="qr-answer-icon"><?php echo e($isRight ? '✅' : '❌'); ?></span>
                    <span class="qr-answer-num">س<?php echo e($loop->iteration); ?></span>
                    <span class="qr-answer-marks">
                        <?php echo e($earned); ?>/<?php echo e($grade); ?>

                        <i class="fas fa-star" style="font-size:10px"></i>
                    </span>
                </div>
                <?php if(!$isRight && $correct): ?>
                <div class="qr-answer-correct">
                    <?php echo e(app()->getLocale() == 'ar' ? 'الصواب:' : 'Correct:'); ?>

                    <strong><?php echo e($correct); ?></strong>
                </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\khalil\resources\views/user/quiz-result.blade.php ENDPATH**/ ?>