...
<div class="tf-wrapper">
    ...
    <div class="tf-header">
        <a href="<?php echo e(route('hub')); ?>" class="tf-back">← العودة</a>
    ...
    <form method="POST"
          action="<?php echo e(route('track.calculate', $user->id)); ?>"
          class="tf-form"
          id="tfForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="tf-subject-card" style="--accent: <?php echo e($s['color']); ?>">
                ...
                <div class="tf-input-wrap">
                    <input
                        ...
                        id="<?php echo e($s['key']); ?>"
                        min="0"
                        max="<?php echo e($s['max']); ?>"
                        value="<?php echo e(old($s['key'])); ?>"
                        placeholder="0"
                        class="tf-input"
                        required
                        oninput="updateBar(this, <?php echo e($s['max']); ?>)"
                    >
                    <span class="tf-input-max">/<?php echo e($s['max']); ?></span>
                </div>
                <div class="tf-progress-bar">
                    <div class="tf-progress-fill"
                         id="bar_<?php echo e($s['key']); ?>"
