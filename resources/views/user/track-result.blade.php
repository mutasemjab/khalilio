...
@section('content')
    <div class="tr-wrapper">
        ...
        <div class="tr-header">
            ...
            <h1 class="tr-title">{{ __('messages.track_result_title') }}</h1>
        </div>
        ...
        <div class="tr-score-card">
            ...
            <div class="tr-score-right">
                <div class="tr-score-detail">
                    <span class="tr-score-label">{{ __('messages.total_sum') }}</span>
        ...
        <div class="tr-subjects-section">
            <h2 class="tr-section-title">{{ __('messages.grade_details') }}</h2>
                        ...
                        <div class="tr-subject-bar-wrap">
                            <div class="tr-subject-bar">
                                <div class="tr-subject-fill"
                                    style="width: {{ $pct }}%; --delay: {{ $loop->index * 0.1 }}s"></div>
                            </div>
                        </div>
        ...
        <div class="tr-tracks-section">
            <h2 class="tr-section-title">{{ __('messages.available_tracks') }}</h2>
