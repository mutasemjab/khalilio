{{-- resources/views/user/quiz-take.blade.php --}}
@extends('layouts.front')

@section('title', 'الامتحان - ' . $quiz->name)
...
<div class="qt-wrapper">
    ...
    <div class="qt-sticky-bar">
        <div class="qt-sticky-inner">
            <div class="qt-quiz-name">🧮 {{ $quiz->name }}</div>
            <div class="qt-timer" id="timer">
                <span class="qt-timer-icon">⏱️</span>
                <span id="timerDisplay">{{ str_pad($quiz->duration_minutes, 2, '0', STR_PAD_LEFT) }}:00</span>
            </div>
        ...
        <div class="qt-questions">
            ...
            <div class="qt-question-card" id="qCard{{ $question->id }}" data-answered="false" style="animation-delay: {{ $i * 0.08 }}s">
                ...
                <div class="qt-q-image">
                    <img src="{{ asset('assets/admin/uploads/' . $question->question_image) }}" alt="صورة السؤال">
                </div>
                @endif
