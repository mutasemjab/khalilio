        ...
        <div class="subjects-grid">
            ...
            <div class="subject-card">
                <div class="subject-header">
                    <div class="subject-icon">🇬🇧</div>
                    <div class="subject-info">
                        <h3 class="subject-name">{{ __('messages.english_language') }}</h3>
                        <span class="subject-description">{{ __('messages.english_desc') }}</span>
                    </div>
                    <div class="max-grade-badge">{{ __('messages.out_of') }} 100</div>
                </div>
                <div class="input-group">
                    <label for="english_grade" class="grade-label">{{ __('messages.english_language') }}:</label>
                    <input 
                        type="number" 
                        name="english_grade" 
                        id="english_grade"
