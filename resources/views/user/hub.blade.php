...
<div class="hub-wrapper">
    ...
    <div class="hub-grid">
        ...
        {{-- → Goes to registration form, after submit → track-finder --}}
        <a href="{{ route('student.form', ['redirect_to' => 'track']) }}" class="hub-card hub-card--track">
        ...
        {{-- → Goes to registration form, after submit → quiz --}}
        <a href="{{ route('student.form', ['redirect_to' => 'quiz']) }}" class="hub-card hub-card--math">
            <div class="hub-card__glow"></div>
        ...
        {{-- → Goes to registration form, after submit → grades --}}
        <a href="{{ route('student.form', ['redirect_to' => 'average']) }}" class="hub-card hub-card--avg">
            <div class="hub-card__glow"></div>
        ...
        {{-- Card 4: الأوائل — public, no registration needed --}}
