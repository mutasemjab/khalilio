{{-- resources/views/user/hub.blade.php --}}
@extends('layouts.front')

@section('title', 'خليليو - الصفحة الرئيسية')
    ...
    <div class="hub-wrapper">
        ...
        <div class="hub-hero">
            ...
            <div class="hub-stars">
                @for ($i = 0; $i < 12; $i++)
                    <span class="hub-star"
                        style="--d:{{ rand(0, 360) }}deg;--r:{{ rand(60, 130) }}px;--s:{{ rand(4, 14) }}px;--delay:{{ $i * 0.18 }}s">
                        ★
                    </span>
                @endfor
            </div>
        ...
        <div class="hub-grid">
            ...
            {{-- Card 4: الأوائل — لا يحتاج user --}}
            <a href="{{ route('top-students.index') }}" class="hub-card hub-card--top">
                <div class="hub-card__glow"></div>
